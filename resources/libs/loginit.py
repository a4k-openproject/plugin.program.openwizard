...
ORDER = ['easynews-fen',
         ...
         'login-eis', 'tmdb-gaia',
         'tmdb-incursion', 'tmdb-fen', 'tmdb-metadatautils', 'tmdb-numbers',
...
LOGINID = {
    ...
    'tmdb-metadatautils': {
        ...
        'activate' : ''},
    'fanart-incursion': {
        'name'     : 'Fanart.tv - Incursion',
        'plugin'   : 'plugin.video.incursion',
        'saved'    : 'fanart-incursion',
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'incursion_fanart'),
    ...
    'tmdb-incursion': {
        'name'     : 'TMDb - Incursion',
        'plugin'   : 'plugin.video.incursion',
        'saved'    : 'tmdb-incursion',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'incursion_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.incursion', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-incursion': {
        'name'     : 'IMDb - Incursion',
        'plugin'   : 'plugin.video.incursion',
        'saved'    : 'imdb-incursion',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.incursion', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'incursion_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.incursion', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
