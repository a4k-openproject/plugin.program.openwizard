...
LOGINID = {
    ...
    'fanart-placenta': {
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'placenta_fanart'),
    ...
    'tmdb-placenta': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.placenta', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.placenta', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'placenta_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.placenta', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-placenta': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.placenta', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.placenta', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'placenta_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.placenta', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    ...
    'fanart-yoda': {
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'yoda_fanart'),
    ...
    'tmdb-yoda': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.yoda', 'icon.jpg'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.yoda', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'yoda_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.yoda', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-yoda': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.yoda', 'icon.jpg'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.yoda', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'yoda_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.yoda', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    'fanart-overeasy': {
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'overeasy_fanart'),
    ...
    'tmdb-overeasy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.overeasy', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.overeasy', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'overeasy_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.overeasy', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-overeasy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.overeasy', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.overeasy', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'overeasy_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.overeasy', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
...
def activate_login(who):
    if LOGINID[who]:
        if os.path.exists(LOGINID[who]['path']):
            ...
            gui.DIALOG.ok(CONFIG.ADDONTITLE, '{0} is not currently installed.'.format(LOGINID[who]['name']))
    else:
        xbmc.executebuiltin('Container.Refresh()')
        return
