...
def toggle_addon_updates(): 
	...
	selected = dialog.select(ADDONTITLE, options) 
			 
	LogNotify(ADDONTITLE, 'Updates changed to "{0}"'.format(options[selected])) 
...
def getCacheSize():
	...
	dbfiles   = [
		...
		(os.path.join(ADDOND, 'plugin.video.venom', 'cache.meta.5.db')),
		(os.path.join(ADDOND, 'plugin.video.venom', 'cache.providers.13.db')),
		(os.path.join(ADDOND, 'plugin.video.numbersbynumbers', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.numbersbynumbers', 'cache.meta.5.db')),
		(os.path.join(ADDOND, 'plugin.video.numbersbynumbers', 'cache.providers.13.db')),
		(os.path.join(ADDOND, 'plugin.video.thecrew', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.thecrew', 'cache.meta.5.db')),
		(os.path.join(ADDOND, 'plugin.video.thecrew', 'cache.providers.13.db')),
