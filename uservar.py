...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR purple][B]Varadero[/B][/COLOR]Wizard'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/nikisb/plugin.program.openwizard/test/builds/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Varadero[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Varadero.\n\nContact us on Github at http://www.github.com/nikisb'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR purple][B]Varadero[/B][/COLOR]Wizard'
