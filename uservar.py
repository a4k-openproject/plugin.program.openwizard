...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR fff16a15]Galexioum[/COLOR] [COLOR white]Wizard[/COLOR]'
BUILDERNAME = 'Galexias'
EXCLUDES = [ADDON_ID, 'repository.galexioum']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://galexioum.000webhostapp.com/repo/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Galexioum[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOID = 'repository.galexioum'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://galexioum.000webhostapp.com/plugins/leia/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://galexioum.000webhostapp.com/plugins/leia/repository.galexioum/'
#########################################################
...
NOTIFICATION = 'https://galexioum.000webhostapp.com/text/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR fff16a15]Galexioum[/COLOR] Wizard'
